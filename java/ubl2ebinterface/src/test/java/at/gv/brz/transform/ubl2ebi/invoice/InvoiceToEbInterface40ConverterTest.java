 ...
 */
public class InvoiceToEbInterface40ConverterTest
{
  private static final Logger s_aLogger = LoggerFactory.getLogger (InvoiceToEbInterface40ConverterTest.class);
  ...
  public void testConvertPEPPOLInvoiceLax ()
  {
    ...
    for (final IReadableResource aRes : aTestFiles)
    {
      ...
      final Ebi40InvoiceType aEbInvoice = new InvoiceToEbInterface40Converter (Locale.GERMANY, Locale.GERMANY, false).convertToEbInterface (aUBLInvoice,
                                                                                                                                            aErrorList);
  ...
  public void testConvertPEPPOLInvoiceERB ()
  {
    ...
    for (final IReadableResource aRes : aTestFiles)
    {
      ...
      // Convert to ebInterface
      final ErrorList aErrorList = new ErrorList ();
      final Ebi40InvoiceType aEbInvoice = new InvoiceToEbInterface40Converter (Locale.GERMANY, Locale.GERMANY, true).convertToEbInterface (aUBLInvoice,
                                                                                                                                           aErrorList);

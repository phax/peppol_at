 ...
 */
public class CreditNoteToEbInterface40ConverterTest
{
  private static final Logger s_aLogger = LoggerFactory.getLogger (CreditNoteToEbInterface40ConverterTest.class);
  ...
  public void testConvertPEPPOLCreditNoteLax ()
  {
    ...
    for (final IReadableResource aRes : aTestFiles)
    {
      ...
      final Ebi40InvoiceType aEbInvoice = new CreditNoteToEbInterface40Converter (Locale.GERMANY, Locale.GERMANY, false).convertToEbInterface (aUBLCreditNote,
                                                                                                                                               aErrorList);
  ...
  public void testConvertPEPPOLInvoiceERB ()
  {
    ...
    for (final IReadableResource aRes : aTestFiles)
    {
      ...
      // Convert to ebInterface
      final ErrorList aErrorList = new ErrorList ();
      final Ebi40InvoiceType aEbInvoice = new CreditNoteToEbInterface40Converter (Locale.GERMANY, Locale.GERMANY, true).convertToEbInterface (aUBLCreditNote,
                                                                                                                                              aErrorList);
